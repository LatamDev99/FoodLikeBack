const { registro, todosRestaurantes, sesion, restauranteDesAct, cambiarContrasena, activosRestaurantes, inactivosRestaurantes, cambiarDatos} = require("../controllers/restauranteController");
